...
object APIClient {
    ...
    fun getSerialDetails(serialId: Int): String {
        return "https://api.themoviedb.org/3/tv/$serialId?api_key=$API_KEY&language=en-US"
    }

    fun getRecommendedSerialsForSerial(serialId: Int): String {
        return "https://api.themoviedb.org/3/tv/$serialId/recommendations?api_key=$API_KEY&language=en-US&page=1"
    }

    fun getSerialsWithActor(actorId: Int): String {
        return "https://api.themoviedb.org/3/person/$actorId/tv_credits?api_key=$API_KEY&language=en-US"
    }

    fun getSearchResultForSerials(query: String): String {
        return "https://api.themoviedb.org/3/search/tv?api_key=$API_KEY&language=en-US&query=$query&page=1"
    }
}