...
class TopShowsFragment : Fragment(), ITopShowsView,
    ...
    private lateinit var searchResultAdapter: SearchResultShowAdapter
    ...
    private fun initResultRecycler() {
        ...
        searchResultAdapter = SearchResultShowAdapter()
        ...
        search_result_recycler_view.apply {
            ...
            val listener = object : SearchResultShowAdapter.OpenListener {
                override fun onItemClickedListener(show: Show) {
                    val intent = Intent(activity, ShowDetailsActivity::class.java)
    ...
    override fun onTextQuery(text: String) {
        if (text.isEmpty()) {
            ...
            topShowsPresenter.onSearchMovies(text)
        }
    }

    override fun onSearchResult(result: ShowsList) {
