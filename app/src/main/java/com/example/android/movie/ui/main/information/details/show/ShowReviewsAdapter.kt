...
import kotlinx.android.synthetic.main.item_view_show_review.view.*

class ShowReviewsAdapter(private var items: ArrayList<Reviews> = ArrayList()) :
    RecyclerView.Adapter<ShowReviewsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_view_show_review, parent, false)
        val holder =
            ViewHolder(
                view
            )
